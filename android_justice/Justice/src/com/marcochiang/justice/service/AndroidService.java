...
//    //
//    public final String accTag ="acc";
...
//    	Log.d(accTag, "start listening");
//    	this.getApplicationContext();
//    	try{
//        sensorManager = (SensorManager) getSystemService(SENSOR_SERVICE);}
//    	catch (Exception e) {
//			Log.d(accTag, "Stuff didn't work...");
//			e.printStackTrace();
//		}
//        
//    }
...
//		Log.d(accTag, "a change happened");
...
//            // compare text?
//            history.add(current) ;
//            Log.d(accTag, mLastX+","+mLastY+","+mLastZ);
